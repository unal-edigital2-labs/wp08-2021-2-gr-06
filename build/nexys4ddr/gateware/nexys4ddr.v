...
module nexys4ddr (
	...
	output reg  uart3_tx,
	input  wire uart3_rx,
	input  wire input_infra0,
	input  wire input_infra1,
	input  wire input_infra2,
	input  wire input_infra3,
	input  wire input_infra4,
	output wire pwm_out,
...
reg  [3:0] basesoc_uart2_tx_fifo_level0 = 4'd0;
reg  basesoc_uart2_tx_fifo_replace = 1'd0;
reg  [2:0] basesoc_uart2_tx_fifo_produce = 3'd0;
reg  [2:0] basesoc_uart2_tx_fifo_consume = 3'd0;
reg  [2:0] basesoc_uart2_tx_fifo_wrport_adr = 3'd0;
...
reg  [3:0] basesoc_uart2_rx_fifo_level0 = 4'd0;
reg  basesoc_uart2_rx_fifo_replace = 1'd0;
reg  [2:0] basesoc_uart2_rx_fifo_produce = 3'd0;
reg  [2:0] basesoc_uart2_rx_fifo_consume = 3'd0;
reg  [2:0] basesoc_uart2_rx_fifo_wrport_adr = 3'd0;
...
reg  builder_csrbank3_output_infra_re = 1'd0;
wire [4:0] builder_csrbank3_output_infra_r;
reg  builder_csrbank3_output_infra_we = 1'd0;
wire [4:0] builder_csrbank3_output_infra_w;
...
reg  builder_csrbank7_orden0_re = 1'd0;
wire [2:0] builder_csrbank7_orden0_r;
reg  builder_csrbank7_orden0_we = 1'd0;
...
reg  builder_csrbank14_orden0_re = 1'd0;
wire builder_csrbank14_orden0_r;
reg  builder_csrbank14_orden0_we = 1'd0;
...
reg  builder_csrbank14_d_re = 1'd0;
wire [7:0] builder_csrbank14_d_r;
reg  builder_csrbank14_d_we = 1'd0;
...
always @(*) begin
	basesoc_uart2_tx_fifo_wrport_adr <= 3'd0;
...
assign basesoc_uart2_tx_fifo_syncfifo2_writable = (basesoc_uart2_tx_fifo_level0 != 4'd8);
...
always @(*) begin
	basesoc_uart2_rx_fifo_wrport_adr <= 3'd0;
...
assign basesoc_uart2_rx_fifo_syncfifo2_writable = (basesoc_uart2_rx_fifo_level0 != 4'd8);
...
assign builder_csrbank1_sel = (builder_interface1_bank_bus_adr[13:9] == 5'd16);
...
assign builder_csrbank3_output_infra_r = builder_interface3_bank_bus_dat_w[4:0];
always @(*) begin
	builder_csrbank3_output_infra_we <= 1'd0;
	builder_csrbank3_output_infra_re <= 1'd0;
	if ((builder_csrbank3_sel & (builder_interface3_bank_bus_adr[8:0] == 1'd0))) begin
		builder_csrbank3_output_infra_re <= builder_interface3_bank_bus_we;
		builder_csrbank3_output_infra_we <= (~builder_interface3_bank_bus_we);
	end
end
assign builder_csrbank3_output_infra_w = basesoc_infra_cntrl_status[4:0];
assign basesoc_infra_cntrl_we = builder_csrbank3_output_infra_we;
...
assign builder_csrbank7_sel = (builder_interface7_bank_bus_adr[13:9] == 4'd14);
assign builder_csrbank7_orden0_r = builder_interface7_bank_bus_dat_w[2:0];
always @(*) begin
	builder_csrbank7_orden0_re <= 1'd0;
	builder_csrbank7_orden0_we <= 1'd0;
	if ((builder_csrbank7_sel & (builder_interface7_bank_bus_adr[8:0] == 1'd0))) begin
		builder_csrbank7_orden0_re <= builder_interface7_bank_bus_we;
		builder_csrbank7_orden0_we <= (~builder_interface7_bank_bus_we);
	end
end
...
assign builder_csrbank9_sel = (builder_interface9_bank_bus_adr[13:9] == 5'd17);
...
assign builder_csrbank11_sel = (builder_interface11_bank_bus_adr[13:9] == 4'd8);
assign basesoc_uart0_rxtx_r = builder_interface11_bank_bus_dat_w[7:0];
always @(*) begin
	...
	if ((builder_csrbank11_sel & (builder_interface11_bank_bus_adr[8:0] == 1'd0))) begin
		basesoc_uart0_rxtx_re <= builder_interface11_bank_bus_we;
		basesoc_uart0_rxtx_we <= (~builder_interface11_bank_bus_we);
	end
end
...
assign builder_csrbank11_txfull_w = basesoc_uart0_txfull_status;
assign basesoc_uart0_txfull_we = builder_csrbank11_txfull_we;
assign builder_csrbank11_rxempty_w = basesoc_uart0_rxempty_status;
assign basesoc_uart0_rxempty_we = builder_csrbank11_rxempty_we;
always @(*) begin
...
assign builder_csrbank11_ev_status_w = basesoc_uart0_status_status[1:0];
assign basesoc_uart0_status_we = builder_csrbank11_ev_status_we;
always @(*) begin
...
assign builder_csrbank11_ev_pending_w = basesoc_uart0_pending_status[1:0];
assign basesoc_uart0_pending_we = builder_csrbank11_ev_pending_we;
assign basesoc_uart0_tx2 = basesoc_uart0_enable_storage[0];
assign basesoc_uart0_rx2 = basesoc_uart0_enable_storage[1];
assign builder_csrbank11_ev_enable0_w = basesoc_uart0_enable_storage[1:0];
assign builder_csrbank11_txempty_w = basesoc_uart0_txempty_status;
assign basesoc_uart0_txempty_we = builder_csrbank11_txempty_we;
assign builder_csrbank11_rxfull_w = basesoc_uart0_rxfull_status;
assign basesoc_uart0_rxfull_we = builder_csrbank11_rxfull_we;
assign builder_csrbank12_sel = (builder_interface12_bank_bus_adr[13:9] == 4'd10);
assign basesoc_uart1_rxtx_r = builder_interface12_bank_bus_dat_w[7:0];
always @(*) begin
	...
	if ((builder_csrbank12_sel & (builder_interface12_bank_bus_adr[8:0] == 1'd0))) begin
		basesoc_uart1_rxtx_re <= builder_interface12_bank_bus_we;
		basesoc_uart1_rxtx_we <= (~builder_interface12_bank_bus_we);
	end
end
...
assign builder_csrbank12_txfull_w = basesoc_uart1_txfull_status;
assign basesoc_uart1_txfull_we = builder_csrbank12_txfull_we;
assign builder_csrbank12_rxempty_w = basesoc_uart1_rxempty_status;
assign basesoc_uart1_rxempty_we = builder_csrbank12_rxempty_we;
always @(*) begin
...
assign builder_csrbank12_ev_status_w = basesoc_uart1_status_status[1:0];
assign basesoc_uart1_status_we = builder_csrbank12_ev_status_we;
always @(*) begin
...
assign builder_csrbank12_ev_pending_w = basesoc_uart1_pending_status[1:0];
assign basesoc_uart1_pending_we = builder_csrbank12_ev_pending_we;
assign basesoc_uart1_tx2 = basesoc_uart1_enable_storage[0];
assign basesoc_uart1_rx2 = basesoc_uart1_enable_storage[1];
assign builder_csrbank12_ev_enable0_w = basesoc_uart1_enable_storage[1:0];
assign builder_csrbank12_txempty_w = basesoc_uart1_txempty_status;
assign basesoc_uart1_txempty_we = builder_csrbank12_txempty_we;
assign builder_csrbank12_rxfull_w = basesoc_uart1_rxfull_status;
assign basesoc_uart1_rxfull_we = builder_csrbank12_rxfull_we;
assign builder_csrbank13_sel = (builder_interface13_bank_bus_adr[13:9] == 4'd12);
assign basesoc_uart2_rxtx_r = builder_interface13_bank_bus_dat_w[7:0];
always @(*) begin
	...
	if ((builder_csrbank13_sel & (builder_interface13_bank_bus_adr[8:0] == 1'd0))) begin
		basesoc_uart2_rxtx_re <= builder_interface13_bank_bus_we;
		basesoc_uart2_rxtx_we <= (~builder_interface13_bank_bus_we);
	end
end
...
assign builder_csrbank13_txfull_w = basesoc_uart2_txfull_status;
assign basesoc_uart2_txfull_we = builder_csrbank13_txfull_we;
assign builder_csrbank13_rxempty_w = basesoc_uart2_rxempty_status;
assign basesoc_uart2_rxempty_we = builder_csrbank13_rxempty_we;
always @(*) begin
...
assign builder_csrbank13_ev_status_w = basesoc_uart2_status_status[1:0];
assign basesoc_uart2_status_we = builder_csrbank13_ev_status_we;
always @(*) begin
...
assign builder_csrbank13_ev_pending_w = basesoc_uart2_pending_status[1:0];
assign basesoc_uart2_pending_we = builder_csrbank13_ev_pending_we;
assign basesoc_uart2_tx2 = basesoc_uart2_enable_storage[0];
assign basesoc_uart2_rx2 = basesoc_uart2_enable_storage[1];
assign builder_csrbank13_ev_enable0_w = basesoc_uart2_enable_storage[1:0];
assign builder_csrbank13_txempty_w = basesoc_uart2_txempty_status;
assign basesoc_uart2_txempty_we = builder_csrbank13_txempty_we;
assign builder_csrbank13_rxfull_w = basesoc_uart2_rxfull_status;
assign basesoc_uart2_rxfull_we = builder_csrbank13_rxfull_we;
assign builder_csrbank14_sel = (builder_interface14_bank_bus_adr[13:9] == 4'd15);
assign builder_csrbank14_orden0_r = builder_interface14_bank_bus_dat_w[0];
always @(*) begin
	builder_csrbank14_orden0_re <= 1'd0;
	builder_csrbank14_orden0_we <= 1'd0;
	if ((builder_csrbank14_sel & (builder_interface14_bank_bus_adr[8:0] == 1'd0))) begin
		builder_csrbank14_orden0_re <= builder_interface14_bank_bus_we;
		builder_csrbank14_orden0_we <= (~builder_interface14_bank_bus_we);
	end
end
...
always @(*) begin
	builder_csrbank14_d_re <= 1'd0;
	builder_csrbank14_d_we <= 1'd0;
	if ((builder_csrbank14_sel & (builder_interface14_bank_bus_adr[8:0] == 2'd2))) begin
		builder_csrbank14_d_re <= builder_interface14_bank_bus_we;
		builder_csrbank14_d_we <= (~builder_interface14_bank_bus_we);
	end
end
...
always @(posedge sys_clk) begin
	...
	if (basesoc_uart3_reset) begin
		...
		basesoc_uart2_tx_fifo_readable <= 1'd0;
		basesoc_uart2_tx_fifo_level0 <= 4'd0;
		basesoc_uart2_tx_fifo_produce <= 3'd0;
		basesoc_uart2_tx_fifo_consume <= 3'd0;
		basesoc_uart2_rx_fifo_readable <= 1'd0;
		basesoc_uart2_rx_fifo_level0 <= 4'd0;
		basesoc_uart2_rx_fifo_produce <= 3'd0;
		basesoc_uart2_rx_fifo_consume <= 3'd0;
	end
	...
	if (builder_csrbank3_sel) begin
		case (builder_interface3_bank_bus_adr[8:0])
			1'd0: begin
				builder_interface3_bank_bus_dat_r <= builder_csrbank3_output_infra_w;
			end
		endcase
	end
	basesoc_infra_cntrl_re <= builder_csrbank3_output_infra_re;
	...
	if (builder_csrbank11_sel) begin
		case (builder_interface11_bank_bus_adr[8:0])
			1'd0: begin
				builder_interface11_bank_bus_dat_r <= basesoc_uart0_rxtx_w;
			end
			1'd1: begin
	...
	basesoc_uart0_txfull_re <= builder_csrbank11_txfull_re;
	basesoc_uart0_rxempty_re <= builder_csrbank11_rxempty_re;
	basesoc_uart0_status_re <= builder_csrbank11_ev_status_re;
	if (builder_csrbank11_ev_pending_re) begin
		basesoc_uart0_pending_r[1:0] <= builder_csrbank11_ev_pending_r;
	end
	basesoc_uart0_pending_re <= builder_csrbank11_ev_pending_re;
	if (builder_csrbank11_ev_enable0_re) begin
		basesoc_uart0_enable_storage[1:0] <= builder_csrbank11_ev_enable0_r;
	end
	basesoc_uart0_enable_re <= builder_csrbank11_ev_enable0_re;
	basesoc_uart0_txempty_re <= builder_csrbank11_txempty_re;
	basesoc_uart0_rxfull_re <= builder_csrbank11_rxfull_re;
	builder_interface12_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank12_sel) begin
		case (builder_interface12_bank_bus_adr[8:0])
			1'd0: begin
				builder_interface12_bank_bus_dat_r <= basesoc_uart1_rxtx_w;
			end
			1'd1: begin
	...
	basesoc_uart1_txfull_re <= builder_csrbank12_txfull_re;
	basesoc_uart1_rxempty_re <= builder_csrbank12_rxempty_re;
	basesoc_uart1_status_re <= builder_csrbank12_ev_status_re;
	if (builder_csrbank12_ev_pending_re) begin
		basesoc_uart1_pending_r[1:0] <= builder_csrbank12_ev_pending_r;
	end
	basesoc_uart1_pending_re <= builder_csrbank12_ev_pending_re;
	if (builder_csrbank12_ev_enable0_re) begin
		basesoc_uart1_enable_storage[1:0] <= builder_csrbank12_ev_enable0_r;
	end
	basesoc_uart1_enable_re <= builder_csrbank12_ev_enable0_re;
	basesoc_uart1_txempty_re <= builder_csrbank12_txempty_re;
	basesoc_uart1_rxfull_re <= builder_csrbank12_rxfull_re;
	builder_interface13_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank13_sel) begin
		case (builder_interface13_bank_bus_adr[8:0])
			1'd0: begin
				builder_interface13_bank_bus_dat_r <= basesoc_uart2_rxtx_w;
			end
			1'd1: begin
	...
	basesoc_uart2_txfull_re <= builder_csrbank13_txfull_re;
	basesoc_uart2_rxempty_re <= builder_csrbank13_rxempty_re;
	basesoc_uart2_status_re <= builder_csrbank13_ev_status_re;
	if (builder_csrbank13_ev_pending_re) begin
		basesoc_uart2_pending_r[1:0] <= builder_csrbank13_ev_pending_r;
	end
	basesoc_uart2_pending_re <= builder_csrbank13_ev_pending_re;
	if (builder_csrbank13_ev_enable0_re) begin
		basesoc_uart2_enable_storage[1:0] <= builder_csrbank13_ev_enable0_r;
	end
	basesoc_uart2_enable_re <= builder_csrbank13_ev_enable0_re;
	basesoc_uart2_txempty_re <= builder_csrbank13_txempty_re;
	basesoc_uart2_rxfull_re <= builder_csrbank13_rxfull_re;
	...
	basesoc_d_re <= builder_csrbank14_d_re;
...
//------------------------------------------------------------------------------
// Memory storage_6: 8-words x 10-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: Sync | Mode: Read-First  | Write-Granularity: 10 
// Port 1 | Read: Sync  | Write: ---- | 
reg [9:0] storage_6[0:7];
...
//------------------------------------------------------------------------------
// Memory storage_7: 8-words x 10-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: Sync | Mode: Read-First  | Write-Granularity: 10 
// Port 1 | Read: Sync  | Write: ---- | 
reg [9:0] storage_7[0:7];
...
Infrarrojo Infrarrojo(
	.input_infra({input_infra4, input_infra3, input_infra2, input_infra1, input_infra0}),
	.output_infra(basesoc_infra_cntrl_status)
);
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-02-11 16:02:12.
//------------------------------------------------------------------------------
