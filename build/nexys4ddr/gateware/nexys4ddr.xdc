...
# uart2:0.tx
set_property LOC G1 [get_ports {uart2_tx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart2_tx}]

# uart2:0.rx
set_property LOC G3 [get_ports {uart2_rx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart2_rx}]

# uart3:0.tx
set_property LOC H2 [get_ports {uart3_tx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart3_tx}]

# uart3:0.rx
set_property LOC G4 [get_ports {uart3_rx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart3_rx}]

# input_infra:0
set_property LOC H14 [get_ports {input_infra0}]
set_property IOSTANDARD LVCMOS33 [get_ports {input_infra0}]

# input_infra:1
set_property LOC G16 [get_ports {input_infra1}]
set_property IOSTANDARD LVCMOS33 [get_ports {input_infra1}]

# input_infra:2
set_property LOC F16 [get_ports {input_infra2}]
set_property IOSTANDARD LVCMOS33 [get_ports {input_infra2}]

# input_infra:3
set_property LOC D14 [get_ports {input_infra3}]
set_property IOSTANDARD LVCMOS33 [get_ports {input_infra3}]

# input_infra:4
set_property LOC E16 [get_ports {input_infra4}]
set_property IOSTANDARD LVCMOS33 [get_ports {input_infra4}]

# pwm_out:0
set_property LOC G6 [get_ports {pwm_out}]
