...
_io = [
  ...
  #  ("led", 11, Pins("T16"), IOStandard("LVCMOS33")),
    ...
    ("input_infra",  0, Pins("H14"), IOStandard("LVCMOS33")),
    ("input_infra",  1, Pins("G16"), IOStandard("LVCMOS33")),
    ("input_infra", 2, Pins("F16"), IOStandard("LVCMOS33")),
    ("input_infra", 3, Pins("D14"), IOStandard("LVCMOS33")),
    ("input_infra", 4, Pins("E16"), IOStandard("LVCMOS33")),
                    

    ("pwm_out",  0, Pins("G6"), IOStandard("LVCMOS33")),
